...
function getAmplitudes(){
  ...
  // let low = fft.getEnergy(min_freq, med1_freq)*(med1_freq - min_freq);
  // let med = fft.getEnergy(med1_freq, med2_freq)*(med2_freq - med1_freq);
  // let high = fft.getEnergy(med2_freq, max_freq)*(max_freq - med2_freq);
  // let total = (low + med + high) / 100.0;
  // low = low / total;
  // med = med / total;
  // high = high / total;
